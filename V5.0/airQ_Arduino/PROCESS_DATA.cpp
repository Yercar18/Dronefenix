...
String PROCESS_DATA::procesarData(double temperatura, double humedad, double presionAtmosferica, int alcohol, int tvoc, int co2, int metano, int NH4, float latitud, float longitud, double fecha)
{
  ...
  int deltaMetano = abs(__metano - metano);
  ...
  else if((deltaTemp > limit) || (deltaHum > limit) || (deltaPresAt > limit) || (deltaAlcohol > limit) || (deltaTVOC > limit) || (deltaCO2 > limit) || (deltaMetano > limit)|| (deltaNH4 > limit))
  {
